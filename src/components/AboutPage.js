...
function AboutPage() {
  return (
    <div style={styles.container}>
      ...
      >
        At Rex AI, we’re building the future of intelligent automation. We develop autonomous AI agents that work independently, handling complex sales and customer service tasks across voice and chat. Our agents don’t just assist—they actively engage, support, and drive results around the clock.
      </motion.p>
      ...
      >
        {[ 
          ...
          { text: "Multi-Channel Expertise: Rex AI agents seamlessly integrate across voice and chat, ensuring customers receive cohesive and consistent support on their preferred channels." },
      ...
      >
        Ready to see the future of AI? <a href="#get-started" style={styles.link}>Get Started with Rex AI</a>
      </motion.p>
